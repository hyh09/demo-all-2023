package com.example.cloud.demoboothelloworld.jdbcSql.util;
...
public class DateLocaDateAndTimeUtil {
     ...
     */
    public <T> List<T> completionTime(List<T> originalData, LocalDate startDate, LocalDate endDate, String defaultValue, Class target, String timeFiled, String valeFiled
                ...
                if (t1 != null) {
                    if (t1 instanceof LocalDate) {
                        ...
                        if (StringUtils.isNotEmpty(t1.toString())) {
                            localDate = LocalDate.parse(t1.toString(), DateTimeFormatter.ofPattern("yyyy-MM-dd"));
                        }
        ...
        for (LocalDate date : definedTimeList) {
            ...
            if (timeFile.getType().isAssignableFrom(LocalDate.class)) {
                ...
                timeFile.set(resultObj, date.format(fmt));
            }
